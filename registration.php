    ...
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
            ...
            if ($prepareStmt) {
                ...
                echo "<div class='alert alert-success'>You've registered successfully. Redirecting...</div>";
        ...
        <footer>
            <div class="form-text text-muted">Already Registered? <a href="login.php" style="color: #ff5757;">Log-in Here</a></p></div>
        </footer>
    </div>
</body>
</html>